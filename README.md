---
# Portafolio Profesional - Valeria | Junior Frontend & Java Full Stack Developer

¡Bienvenido/a a mi portafolio! En este espacio presento mi perfil profesional, mis competencias técnicas en el análisis y desarrollo de software (ADSO), y las propuestas de arquitectura para soluciones web interactivas y robustas.
...
* **Desafíos y Soluciones:** El reto principal consistió en reestructurar documentación técnica obsoleta y asegurar la precisión de los enlaces directos en el entorno móvil. Se resolvió analizando la arquitectura del SDK previo, estandarizando los formatos de documentación bajo directrices actuales y validando las rutas de redirección urbana.
* **Tecnologías:** iOS SDK, Deep Linking, Formateo de Documentación Técnica, Git.

### 📊 3. Desarrollo Frontend y UI/UX - CRM "Pana Cambios"
* **Propósito:** Desarrollar la interfaz de usuario y optimizar la experiencia del cliente (UI/UX) para una plataforma de gestión de relaciones (CRM), garantizando un entorno intuitivo, reactivo y eficiente.
* **Contexto:** Creación integral de la aplicación frontend, incluyendo módulos críticos como el menú de inicio de sesión y páneles de administración interna para la gestión de flujos de trabajo.
...
## 🛠️ Habilidades Técnicas (Resumen CV)

* **Frontend:** HTML5 Semántico, CSS3 (Estructuras Flexbox/Grid, Medidas Rem/Em), JavaScript Moderno (ES6+), React.
* **Backend:** Java Base, Principios de Programación Orientada a Objetos (POO).
* **Herramientas & Entornos:** Git, GitHub, Figma (Diseño Wireframes y Prototipado).

---
## ✉️ Contacto y Presencia Digital

* **Ubicación:** Bogotá, Colombia
* **LinkedIn:** https://www.linkedin.com/in/valeria-gutierrez-desarrolladora-full-stack/
* **GitHub:** https://github.com/Valeplay27?tab=repositories
* **Correo:** valeriagutierrez193@gmail.com
